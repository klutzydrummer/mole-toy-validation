...
| `zone_e.py` | `references/components/zone_ed_pipeline.md` | CRLEncoder, CRLEncoderFull, TransformerEncoder, DiffAttnEncoder, MLAEncoder, IdentityEncoder |
...
1. **Read the component spec(s)** for that file (see table above).
